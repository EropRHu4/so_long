...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/24 17:19:30 by syule             #+#    #+#             */
/*   Updated: 2022/06/24 17:19:31 by syule            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	wall_init(t_mlx *mlx)
{
	...
	(mlx->mlx, "texturs_32/wall.xpm", &mlx->im.width, &mlx->im.hight);
...
char	*mlx_init_im(t_mlx *mlx)
{
	...
	(mlx->mlx, "texturs_32/floor.xpm", &mlx->im.width, &mlx->im.hight);
	...
	"texturs_32/gummy_bear.xpm", &mlx->im.width, &mlx->im.hight);
